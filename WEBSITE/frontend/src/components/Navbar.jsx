...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      {/* <img onClick={() => navigate('/')} className='w-10 h-10 cursor-pointer' src="C:\Users\Jasskaran Singh\Desktop\Doctor appointment\doctor-appointment-website\frontend\src\assets\assets_frontend\graduate-hat.png" alt="" /> */}
       <h2 className='w-44 font-[Poppins] text-3xl font-bold'>SkillBridge</h2>
